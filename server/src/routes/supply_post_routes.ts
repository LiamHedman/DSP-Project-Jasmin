...
router.post("/new_supply_post", async (req: Request, res: Response) => {
    const { id, owner_id, title, description, price, category, category_type, location, post_picture_url, created_at } = req.body;

    try {
        const post_data = new Supply_post(owner_id, title, description, price, category, category_type, location, post_picture_url, created_at);
